        ...
        >
            ...
            >
                ...
                <div className="flex justify-between items-center lg:hidden">
                    ...
                    <button onClick={handlecombinedproperty}
                        className={`cursor-pointer text-2xl relative`} behavior="smooth">
                        {bars ? <FontAwesomeIcon icon={faBars} /> : <FontAwesomeIcon icon={faXmark} />}
                    </button>
                </div>
                <div className={`lg:hidden top-12 h-svh absolute w-65 bg-[#080e21] shadow-md
                    ...
                    <nav className="flex flex-col gap-10 py-6 px-8 text-xl">
                        {links.map((item) => (
                            <div key={item} className="relative group w-fit">
                                ...
                                <span className="absolute rounded-full -bottom-2 -left-2.5 -right-2.5 h-0.5 bg-purple-700 origin-left scale-x-0 transition-transform duration-300 ease-out group-hover:scale-x-100">
                                </span>
                            </div>
                        ))}
                    </nav>
